...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/robots.txt", (req, res) => {
    res.type('text/plain');
    res.sendFile(require('path').join(process.cwd(), 'client/public/robots.txt'));
  });

  app.get("/sitemap.xml", (req, res) => {
    res.type('application/xml');
    res.sendFile(require('path').join(process.cwd(), 'client/public/sitemap.xml'));
  });

  app.get("/manifest.json", (req, res) => {
    res.type('application/json');
    res.sendFile(require('path').join(process.cwd(), 'client/public/manifest.json'));
  });

  app.get("/.well-known/security.txt", (req, res) => {
    res.type('text/plain');
    res.sendFile(require('path').join(process.cwd(), 'client/public/.well-known/security.txt'));
  });
